<?php
    ...
    'menu' => "MENU",
    'home' => "Home",
    'linking_the_fdi' => "Linking the FDI and Excellent Local Supplies ",
    'about' => "About",
    'outline' => "Outline",
    ...
    'phone_no' => "Phone No",
    'database_on_potential' => "Database on Potential Supplier Companies in Myanmar",
    ...
    'npt_address' => "Investment and Cooperation Department, Ministry of Planning, Finance and Industry, Office No. (37), Nay Pyi Taw",
    ...
    'select_inquiry' => "Select Inquiry Category"
   ];
?>