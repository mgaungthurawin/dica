                          ...
                          <table class="table">
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td colspan="8">
                                    {!! Form::text('md_ceo_position', null, ['class' => 'form-control']) !!}</td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td>
                                {!! Form::text('customer_prefix[]', null, ['class' => 'form-control']) !!}</td>
                              ...
                              <tr>
                                <td>
                                {!! Form::text('customer_percent[]', null, ['class' => 'form-control']) !!}</td>
                              ...
                              <tr>
                                ...
                                <td>Number</td>
                                <td colspan="2">
                                {!! Form::text('cer_number', null, ['class' => 'form-control']) !!}</td>
                                <td>Acquired Year</td>
                                <td colspan="2">
                                {!! Form::text('cer_acquired_year', null, ['class' => 'form-control']) !!}</td>
                                <td>Sprcify</td>
                                <td colspan="6">
                                {!! Form::text('cer_sprcify', null, ['class' => 'form-control']) !!}</td>
                              </tr>
